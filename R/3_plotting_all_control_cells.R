...
all_cells_nn <- read.csv(file.path("data", "all_ctrl_cells_clusters+embeddings_nn.csv"))
sc@tsne <- all_cells_nn[, c("V1", "V2") ]

#validate that the clustering is consistent
table(sc@cpart, all_cells_nn$Cluster)
